...
const uri = 'mongodb+srv://wendy24:wendy_ptr2402@artists.klushnh.mongodb.net/?retryWrites=true&w=majority'
//'mongodb+srv://rodrigomencias08:o8Nl0JitEmFTB6YB@cluster0.7ipkl3j.mongodb.net/?retryWrites=true&w=majority';
  ...
  try {
    ...
    app.get('/users', async (req, res) => {
      try {
        ...
        const collection = db.collection('artists_comments');
    ...
    app.get('/documents/:objectId/reactions/:reactionId', async (req, res) => {
      ...
      try {
        const db = client.db('artists');
        const collection = db.collection('artists_summary_reactions');
